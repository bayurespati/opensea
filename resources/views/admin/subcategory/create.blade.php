        ...
        <div class="row">
            <div data-wow-delay="0s" class="wow fadeInUp col-12">
                <div class="widget-content-inner description">
                    ...
                    <form id="commentform" class="comment-form" action="/admin/subcategory/store" method="POST">
                        @csrf
                        <div class="wrap-content w-full">
                            ...
                            <div class="btn-submit flex gap30 justify-center">
                                ...
                                <button class="tf-button style-1 h50" type="submit">Submit subcategory</button>
                            </div>
                            @if (count($errors) > 0)
