                            ...
                            <div class="swiper-slide">
                                <div class="tf-card-box" style="background: #DEE8E8 !important;">
                                    ...
                                    <div class="meta-info text-center">
                                        <h5 class="name">
                                            <a <?php echo ("href='/detail_product/$item->id'") ?> style="color: #434141">
                                                <span class="text-overf">
                                                    {{$item->nama_produk}}
                                                </span>
                                            </a>
                                        </h5>
                                        <h6 class="price gem" style="color: #434141">{{number_format($item->harga, 0, '.', ',')}}</h6>
                                    </div>
                                </div>
                            </div>
                            @endforeach
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="swiper-container seller seller-slider2" data-swiper='{
                    ...
                    <div class="swiper-wrapper" id="show-item-2">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="swiper-container seller seller-slider2" data-swiper='{
                                ...
                                "navigation": {
                                    "clickable": true,
                                    "nextEl": ".seller-next-1",
                                    "prevEl": ".seller-prev-1"
                                },
                                "breakpoints": {
                                    "768": {
                                        "slidesPerView": 2,
                ...
                <div class="swiper-button-next seller-next-1 over active"></div>
                <div class="swiper-button-prev seller-prev-1 over"></div>
                @endif
    ...
    <div class="themesflat-container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="tf-box-icon relative text-center bg-white">
                    <div class="image">
                        <img src="assets/images/box-icon/step1.png" alt="">
                        <p style="color: #434141">Step 1</p>
                    </div>
                    <h4 class="heading"><a href="#" style="color: #434141">Telusuri Perangkat</a></h4>
                    <p class="content" style="color: #434141">Cari perangkat sesuai dengan kebutuhan Anda</p>
                    <div class="arrow">
                        <svg width="114" height="114" viewBox="0 0 114 114" fill="white" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="tf-box-icon relative text-center type-1">
                    <div class="image">
                        ...
                        <p style="color: #434141">Step 2</p>
                    </div>
                    <h4 class="heading"><a href="#" style="color: #434141">Masukan Whishlist</a></h4>
                    <p class="content" style="color: #434141">Daftarkan perangkat yang diminati ke dalam keranjang belanja</p>
                    <div class="arrow">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="tf-box-icon relative text-center">
                    <div class="image">
                        ...
                        <p style="color: #434141">Step 4</p>
                    </div>
                    <h4 class="heading"><a href="#" style="color: #434141">Detil Daftar Perangkat</a></h4>
                    <p class="content" style="color: #434141">Cek kembali daftar pesanan Anda untuk dimasukan ke dalam pengadaan</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="tf-section action">
    <div class="themesflat-container">
        <div class="row">
            <div class="col-md-12">
                <div class="action__body bg-white">
                    <div class="tf-tsparticles">
                        <div id="tsparticles1" data-color="#161616" data-line="#000"></div>
                    </div>
                    <h2 class="text-center capitalize mx-auto mw-667">Koleksi terbaru dari <br> CISCO</h2>
