                    ...
                    <div class="inner-mobile-nav">
                        ...
                        <nav id="mobile-main-nav" class="mobile-main-nav">
                            <ul id="menu-mobile-menu" class="menu">
                                <li class="menu-item">
                                    <a class="item-menu-mobile" href="about-us.html">FaQ</a>
                                </li>
                            </ul>
                        </nav>
                        <div class="widget-search mt-30">
                            <form action="#" method="get" role="search" class="search-form relative">
                                <input type="search" class="search-field style-1" placeholder="Searchl..." value="" name="s" title="Search for" required="">
                                <button class="search search-submit" type="submit" title="Search">
                                    <i class="icon-search"></i>
                                </button>
                            </form>
                                            ...
                                            <div class="tf-card-box">
                                                <div class="card-media">
                                                    ...
                                                    <div class="button-place-bid">
                                                        <a href="#" data-toggle="modal" data-target="#popup_bid" class="tf-button"><span>Pesan</span></a>
                                                    </div>
                                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="tf-box-icon relative text-center">
                                ...
                                <h4 class="heading"><a href="contact-us.html">Pesan Daftar Perangkat</a></h4>
